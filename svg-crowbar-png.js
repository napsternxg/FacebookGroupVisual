  ...
  (function() {
    ...
    function createPopover(sources) {
      ...
      sources.forEach(function(d, i) {
        ...
        buttonPNG.setAttribute("class", "btn btn-success");
    ...
    function downloadPNG(source) {
      ...
      //console.log(source.style["width"], source.style["height"]);
      var filename = "untitled";
      ...
      image.onload = function() {
        ...
        holderImage.setAttribute("src", image.src);
        body.appendChild(holderImage);
        ...
        canvg(document.getElementById('svg-image'), source.source[0]);
        ...
        var pngimg = '<img src="'+canvasdata+'" width="'+image.width+'" height="'+image.height+'">'; 
        ...
        a.click();
        var s = document.querySelectorAll(".svg-crowbar");
        for(i = 0; i < s.length; i++){s[i].parentElement.removeChild(s[i]);};
